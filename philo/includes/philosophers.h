...
#  define WRONG_ARG_COUNT "\033[0;31mInvalid number of arguments.\nUsage: ./conscience number_of_philosophers time_to_die time_to_eat time_to_sleep [optional_number_of_meals]\033[0m"
...
#  define WRONG_TIME_TO_DIE "\033[0;31mInvalid time to die. Must be a digit between 60 and SIZE_T_MAX/1000.\033[0m"
# endif //WRONG_TIME_TO_DIE

# ifndef WRONG_TIME_TO_EAT
#  define WRONG_TIME_TO_EAT "\033[0;31mInvalid time to eat. Must be a digit between 60 and SIZE_T_MAX/1000.\033[0m"
# endif //WRONG_TIME_TO_EAT

# ifndef WRONG_TIME_TO_SLEEP
#  define WRONG_TIME_TO_SLEEP "\033[0;31mInvalid time to sleep. Must be a digit between 60 and SIZE_T_MAX/1000.\033[0m"
# endif //WRONG_TIME_TO_SLEEP

# ifndef WRONG_MEAL_COUNT
#  define WRONG_MEAL_COUNT "\033[0;31mInvalid number of meals. Must be between 0 and SIZE_T_MAX/1000.\033[0m"
